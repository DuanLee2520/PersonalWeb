...
<body>
  ...
  <form action="UpdateData.php" method="post">
    <header id="header" class="header-tops">
      ...
      <div class="container">
        <input class="input" type="text" name="gg" id="gg">
        
        <h1><input type="text" name="Title" id="Title" value="Frank Page"></h1>
        <h2 style="color:#fff"><input type="text" name="Introduction" id="Introduction" value="I am a professor·····"></h2>
        <nav class="nav-menu d-none d-lg-block">
          <ul>
            <li class="active"><input type="text" name="Nar1" id="Nar1" value="Home"></li>
            <li><a href="#about" class="link"> <span><input class="input" type="text" name="Nar2" id="Nar2" value="About"></span></a></li>
            <li><input type="text" name="Nar3" id="Nar3" value="Education"></li>
            <li><input type="text" name="Nar4" id="Nar4" value="Experience"></li>
   <!--          <li><a href="#projects"> <span>Projects</span></a></li>-->
            <li><a href="#portfolio" class="link"> <span><input type="text" name="Nar5" id="Nar5" value="Projects"></span></a></li>
